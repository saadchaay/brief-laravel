    ...
    <div class="bg-white w-8/12 rounded-md shadow-md h-auto py-3 px-3 my-3">
        ...
        <form action="{{ route('comments') }}" method="post">
            <div class="flex justify-center items-center">
                ...
                @enderror
                <input type="text" class="mt-4 border border-grey w-full border-1 rounded-full p-2 relative focus:border-red pl-8 text-grey-dark font-light w-full text-sm font-medium tracking-wide rounded-full bg-gray-100" placeholder="Type your commnet..." />
